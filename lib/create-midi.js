...
function noteToMidi(note) {
  note = note.replace('x', '##').replace('bb', '♭♭'); // Substitui 'x' por '##' e 'bb' por '♭♭'
...
function calculateTotalDuration(chordType) {
  const durationMap = {
    ...
    "/5": 1, "7alt": 1.5, "M6": 1.5, "m6": 1.5,
    "M7#11": 1.5, "m7b9": 1.5, "m9": 1.5, "dim7": 1.5,
    "madd9": 1.5, "add9": 1.5, "sus2": 1, "5": 1,
    "13": 1.5, "m13": 1.5, "7#9": 1.5, "7b9": 1.5,
    "9sus4": 1.5, "6/9": 1.5, "7b5": 1.5, "7#5": 1.5
  };
